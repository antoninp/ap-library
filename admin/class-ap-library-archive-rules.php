...
class Ap_Library_Archive_Rules {
	...
	public function get_default_rules() {
		return [
			...
			'tax:aplb_portfolio'       => [ 'enabled' => true, 'post_types' => [ 'aplb_photo' ], 'orderby' => 'meta_value', 'meta_key' => APLB_META_PUBLISHED_DATE, 'order' => 'DESC', 'posts_per_page' => '' ],
			'tax:aplb_location'        => [ 'enabled' => true, 'post_types' => [ 'aplb_photo' ], 'orderby' => 'meta_value', 'meta_key' => APLB_META_PUBLISHED_DATE, 'order' => 'DESC', 'posts_per_page' => '' ],
	...
	public function render_rules_page() {
		...
		$contexts = [
			...
			'tax:aplb_portfolio' => __( 'Portfolio Taxonomy Archive', 'ap-library' ),
			'tax:aplb_location' => __( 'Photo Location Taxonomy Archive', 'ap-library' ),
