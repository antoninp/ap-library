<?php
class Ap_Slideshow_Block {
    public function register_block() {
        wp_register_script(
            'ap-slideshow-block',
            plugins_url( '../public/js/ap-slideshow-block.js', __FILE__ ),
            array( 'wp-blocks', 'wp-element', 'wp-editor', 'wp-components', 'wp-block-editor' ),
            filemtime( plugin_dir_path( __FILE__ ) . '../public/js/ap-slideshow-block.js' ),
            true
        );

        register_block_type( 'ap-slideshow/ap-slideshow', array(
            'editor_script'   => 'ap-slideshow-block',
    ...
    public function render_block( $attributes ) {
        ...
        >
            <div class="ap-slideshow-edge ap-slideshow-edge-left"></div>
            <div class="ap-slideshow-edge ap-slideshow-edge-right"></div>
            <?php if ($showArrows === 'true'): ?>
                <button class="ap-slideshow-arrow left" type="button"><?php echo $arrow_left_svg; ?></button>
                <button class="ap-slideshow-arrow right" type="button"><?php echo $arrow_right_svg; ?></button>
            <?php endif; ?>
            ...
            <?php if ($showCaptions === 'true'): ?>
                <div class="ap-slideshow-caption"></div>
            <?php endif; ?>
            <?php if ($showDots === 'true'): ?>
                <div class="ap-slideshow-dots"></div>
            <?php endif; ?>
            <div class="ap-slideshow-link"></div>
        </div>
        <?php
        return ob_get_clean();
    }
